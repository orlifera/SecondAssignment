...
public class RomanPrinterTest {
    ...
    @Test
    public void testPrintI() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
        int arabic_number = 1;
    ...
    @Test
    public void testPrintV() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
        int arabic_number = 5;
    ...
    @Test
    public void testPrintX() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
    ...
    @Test
    public void testPrintL() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException{
    ...
    @Test
    public void testPrintC() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
    ...
    @Test
    public void testPrintD() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
    ...
    @Test
    public void testPrintM() throws NumberBelowZeroException, NumberOverFiveThousand, NRCException {
